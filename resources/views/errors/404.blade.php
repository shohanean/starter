...
<body data-kt-name="metronic" id="kt_body" class="app-blank app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <style>
            body {
                background-image: url("{{ asset('dashboard_assets/media/auth/bg1.jpg') }}");
            }

            [data-theme="dark"] body {
                background-image: url("{{ asset('dashboard_assets/media/auth/bg1-dark.jpg') }}");
            }
            ...
            <div class="d-flex flex-column flex-center text-center p-10">
                ...
                <div class="card card-flush w-lg-650px py-5">
                    <div class="card-body py-15 py-lg-20">
                        ...
                        <!--begin::Illustration-->
                        <div class="mb-3">
                            <img src="{{ asset('dashboard_assets/media/auth/404-error.png') }}" class="mw-100 mh-300px theme-light-show"
                                alt="" />
                            {{-- <img src="{{ asset('dashboard_assets/media/auth/404-error-dark.png') }}" class="mw-100 mh-300px theme-dark-show" alt="" /> --}}
                        </div>
                        <!--end::Illustration-->
                        <!--begin::Link-->
                        <div class="mb-0">
